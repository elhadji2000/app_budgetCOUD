...
<main>
    ...
    <div class='text-center' style='margin-bottom:20px;color:#4655a4;'>
            <h3>ENREGISTREMENT DES ORDRES DE RECETTE</h3>
            <strong style='color:rgba(78, 120, 93, 0.91);'><i>Veuillez choisir le compte concerné afin d'obtenir la liste de ses engagements!</i></strong>
        </div>

        <!-- Formulaire centré avec design -->
        <form action='add_rec2.php' method='GET'>
            <div
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-success">
            ...
            <div class="modal-body">
                🎉 L'operation a été enregistrée avec succès !
            </div>
