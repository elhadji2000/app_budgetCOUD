...
<main>
    ...
    <div class='text-center' style='margin-bottom:20px;color:#4655a4;'>
        <h4>REALISATIONS: <?= number_format($sommeDotations, 0, ',', ','); ?> FCFA /
            <?= number_format($sommeEngs, 0, ',', ','); ?> FCFA soit <?= number_format($taux, 2); ?>%</h4>
    </div>
    ...
    <div class="text-center" style="font-size: 12px; font-weight: 400; margin-top: 20px;">
